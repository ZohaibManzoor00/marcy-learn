              ...
              <Draggable key={course.id} index={idx} draggableId={course.id}>
                {(provided) => (
                  ...
                  >
                    <div
                      className={cn(
                        "px-2 py-2 border-r dark:hover:bg-zinc-800 border-r-slate-200 dark:border-r-slate-600 hover:bg-slate-300 rounded-l-md transition",
                        course.isPublished &&
                    ...
                    <div className="ml-auto pr-2 flex items-center gap-x-2">
                      {!course.isPublished && <Badge className="dark:bg-zinc-900 dark:hover:bg-slate-950 dark:text-gray-100">Locked</Badge>}
                      <Badge
                        className={cn(
                          "bg-slate-500 dark:text-gray-100 dark:hover:bg-slate-700",
                          course.isPublished && "bg-sky-700 dark:hover:bg-sky-800"
                        )}
                      >

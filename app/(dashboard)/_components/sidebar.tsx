          ...
          <div className="space-y-2">
            <div className="flex items-center gap-4 justify-evenly">
              {socials.map(({ href, icon: Icon, label }) => (
                <Link
                  key={href}
                  className="rounded-full flex h-8 w-8 items-center justify-center border border-gray-200 hover:border-gray-200 hover:bg-gray-200 dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:border-gray-700"
                  href={href}
                  target="_blank"
                >
